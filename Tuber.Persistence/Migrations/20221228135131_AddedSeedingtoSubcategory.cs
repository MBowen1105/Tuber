...
{
    /// <inheritdoc />
    public partial class AddedSeedingtoSubcategory : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("cac01b14-67a7-4372-8eb1-5e9a0e8a007c"), new Guid("02ceedc1-d3b4-4e5e-8844-0d853c24463b"), new DateTime(2022, 12, 28, 13, 51, 31, 103, DateTimeKind.Utc).AddTicks(3923), true, false, "Fuel", null, null });

            migrationBuilder.InsertData(
                table: "CategorySubcategories",
                columns: new[] { "CategorySubcategoryId", "CategoryId", "IsDeleted", "SubcategoryId" },
                values: new object[] { new Guid("e79d158e-dd3c-4b13-86da-e0b8f9109ff7"), new Guid("97ea6440-ddb5-42ad-967f-5c9d34646b14"), false, new Guid("cac01b14-67a7-4372-8eb1-5e9a0e8a007c") });
        }
