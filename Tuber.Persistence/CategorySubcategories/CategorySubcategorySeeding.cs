...
public static class CategorySubcategorySeeding
{
    ...
    public static readonly Guid MotorRepaymentsId = Guid.Parse("08c3ab1e-0554-4e70-8432-8443224dd42d");
    ...
    public static readonly Guid HouseholdServicesInternetId = Guid.Parse("d9035a09-2be1-4322-84f7-30397e4f50f2");
    public static readonly Guid BankChargesDebitInterestId = Guid.Parse("daaf4e6f-00dd-40c0-837f-cb566deb743f");
    ...
    public static void Seed(EntityTypeBuilder<CategorySubcategory> builder)
    {
        ...
        builder.HasData(
           new CategorySubcategory
           {
               CategorySubcategoryId = HouseholdServicesInternetId,
               CategoryId = CategorySeeding.HouseholdServicesCategoryId,
               SubcategoryId = SubcategorySeeding.InternetSubcategoryId,
               IsCoreCategorySubcategory = true,
           });
        ...
        builder.HasData(
           new CategorySubcategory
           {
               CategorySubcategoryId = BankChargesDebitInterestId,
               CategoryId = CategorySeeding.BankChargesCategoryId,
               SubcategoryId = SubcategorySeeding.DebitInterestSubcategoryId,
               IsCoreCategorySubcategory = true,
           });
        ...
        builder.HasData(
           new CategorySubcategory
           {
               CategorySubcategoryId = MotorRepaymentsId,
               CategoryId = CategorySeeding.MotorCategoryId,
               SubcategoryId = SubcategorySeeding.RepaymentsSubcategoryId,
           });
    }
}
